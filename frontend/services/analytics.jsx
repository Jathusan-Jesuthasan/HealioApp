...
const api = axios.create({
  baseURL: `${guessBaseURL()}/api/dashboard`, // ✅ target dashboard routes
  timeout: 15000,
});
...
export async function getDashboard(range = "7d") {
  const { data } = await api.get("/", { params: { range } });
  return data;
}

// AI Risk Analysis (Gemini-based analysis of recent mood logs)
