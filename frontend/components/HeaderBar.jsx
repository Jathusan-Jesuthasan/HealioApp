...
export default function HeaderBar({ navigation, unreadCount = 0 }) {
  // simple entrance + attention animations
  ...
  useEffect(() => {
    // Badge pulse only when there are unread
    if (unreadCount > 0) {
      Animated.loop(
        Animated.sequence([
  ...
  return (
    <SafeAreaView edges={["top"]} style={styles.wrap}>
      ...
      <View style={styles.bgWrap}>
        ...
        {/* green accent blob on the right */}
